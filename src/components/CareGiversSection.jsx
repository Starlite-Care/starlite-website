      ...
      <div className="flex flex-col w-[86%] md:w-full xl:w-full md:flex-row items-stretch mx-auto max-w-[1380px] rounded-xl overflow-hidden sm:rounded-none bg-[#F9F3FF]">
        ...
        <div className="w-full md:w-7/12 p-6 md:p-12 lg:p-16">
          ...
          <p className="text-base md:text-lg font-geistRegular text-gray-600 leading-relaxed max-w-2xl">
            We take pride in our team of skilled caregivers, who are carefully
            screened, trained, and dedicated to providing exceptional care.
            Every caregiver at Starlite Care is selected not just for their
            qualifications, but for their passion and commitment to helping
            others.
          </p>
        </div>
      </div>
