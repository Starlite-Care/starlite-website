      ...
      <div className="max-w-xs mt-14">
        <div className="relative flex justify-center items-center">
          {images.map((src, index) => (
            ...
            >
              <img src={src} alt={`Family ${index + 1}`} className="w-full h-full object-cover" />
            </div>
          ))}
        </div>
    ...
    return (
      <div className="bg-[url('/images/bg.png')] bg-cover bg-center min-h-[50vh] sm:min-h-screen w-full">
        <div className="py-16 sm:py-32 px-6 sm:px-28">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center sm:mt-10 space-y-4 md:space-y-0">
  <Link 
    href="/contactUs" 
