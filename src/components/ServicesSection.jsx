...
const ServicesSection = () => {
  ...
  return (
    <section className="py-8 px-4 mt-8 md:py-10 md:px-16 lg:px-24 bg-white">
      <div className="max-w-6xl mx-auto px-5 w-[100%]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className=" rounded-md p-6 flex flex-col justify-center items-center sm:items-start">
            <span className="text-black font-geistRegular text-xs leading-6">
              Our services
            </span>
            <span className="text-black font-geistBold text-2xl md:text-3xl leading-6 mt-2">
              What We Do
            </span>
          </div>
