...
const TestimonialCard = ({ testimonial, isMiddle }) => (
  <div
    className={`bg-white rounded-lg p-2 shadow-md flex flex-col justify-between w-[89%] md:w-[360px] ${
      isMiddle ? "md:h-[280px] md:z-10" : "md:h-[260px] md:-mt-2"
    } transition-all duration-300 mb-6 md:mb-0`}
  >
    <div>
      <div className=" mb-2">
